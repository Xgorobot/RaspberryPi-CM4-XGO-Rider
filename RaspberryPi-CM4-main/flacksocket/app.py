...
#Load Image
app_image = Image.open("/home/pi/RaspberryPi-CM4-main/pics/riderapp.png") 
unapp_image = Image.open("/home/pi/RaspberryPi-CM4-main/pics/riderunapp.png")
...
'''
    Function Name:monitor_connection
    Function Content:Monitor Web Connect Status
'''
...
def handle_left(data):  
    ...
    print('l')
    print(data)
    socketio.start_background_task(dog.rider_turn,int(data))
...
def handle_height(data):  
    ...
    if data == 50:
        ...
        data = 90-(90-60)*(50-data)/50
    elif 50 < data <100:
        data = 90+(120-90)*(data-50)/50
    print(data)
