...
def show_words_dog():
    lcd_draw_string(draw, 10, 150, "左右摇摆|高低起伏|前进后退", color=(0, 255, 255), scale=font2, mono_space=False)
    lcd_draw_string(draw, 10, 170, "四方蛇形|升降旋转|圆周晃动", color=(0, 255, 255), scale=font2, mono_space=False)
    #display.ShowImage(splash)
