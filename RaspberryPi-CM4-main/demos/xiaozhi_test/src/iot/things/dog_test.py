...
class MychanicalDog(Thing):
    def __init__(self):
        ...
        self.add_method(
            ...
            "机械狗的步态设置",
            [
                Parameter('gait', '模式选择(1,2,3,4之间的一个),1表示trot,是小跑步态,2表示walk，是行走步态,3表示high_walk,是高抬腿步态，4表示slow_trot,是慢跑步态，用于微调，默认为1', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的左前腿下面的舵机",
            [
                Parameter('data', '机械狗的左前腿下面的舵机角度,是指小腿顺时针旋转或者逆时针旋转，取值范围是[-73,57]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的左前腿中间的舵机",
            [
                Parameter('data', '机械狗的左前腿中间的舵机角度,是指大腿顺时针旋转或者逆时针旋转，取值范围是[-66,93]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的左前腿上面的舵机",
            [
                Parameter('data', '机械狗的左前腿上面的舵机角度,取值为正时，机械狗的大腿会向外伸展，取值范围是[-31,31]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的右前腿下面的舵机",
            [
                Parameter('data', '机械狗的右前腿下面的舵机角度,是指小腿顺时针旋转或者逆时针旋转，取值范围是[-73,57]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的右前腿中间的舵机",
            [
                Parameter('data', '机械狗的右前腿中间的舵机角度,是指大腿顺时针旋转或者逆时针旋转，取值范围是[-66,93]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的右前腿上面的舵机",
            [
                Parameter('data', '机械狗的右前腿上面的舵机角度,取值为正时，机械狗的大腿会向外伸展，取值范围是[-31,31]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的右后腿下面的舵机",
            [
                Parameter('data', '机械狗的右后腿下面的舵机角度,是指小腿顺时针旋转或者逆时针旋转，取值范围是[-73,57]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的右前腿中间的舵机",
            [
                Parameter('data', '机械狗的右后腿中间的舵机角度,是指大腿顺时针旋转或者逆时针旋转，取值范围是[-66,93]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的右前腿上面的舵机",
            [
                Parameter('data', '机械狗的右后腿上面的舵机角度,取值为正时，机械狗的大腿会向外伸展，取值范围是[-31,31]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的左后腿下面的舵机",
            [
                Parameter('data', '机械狗的左后腿下面的舵机角度,是指小腿顺时针旋转或者逆时针旋转，取值范围是[-73,57]', ValueType.NUMBER, True)
            ],
            lambda params: self._motor_31(params["data"].get_value())
        )
        self.add_method(
            ...
            "机械狗的左前腿中间的舵机",
            [
                Parameter('data', '机械狗的左后腿中间的舵机角度,是指大腿顺时针旋转或者逆时针旋转，取值范围是[-66,93]', ValueType.NUMBER, True)
            ],
            lambda params: self._motor_32(params["data"].get_value())
        )
        self.add_method(
            ...
            "机械狗的左前腿上面的舵机",
            [
                Parameter('data', '机械狗的左后腿上面的舵机角度,取值为正时，机械狗的大腿会向外伸展，取值范围是[-31,31]', ValueType.NUMBER, True)
            ],
            lambda params: self._motor_33(params["data"].get_value())
        )
        ...
        self.add_method(
            ...
            "机械狗的机械臂夹爪的舵机",
            [
                Parameter('data', '机械狗的机械臂夹爪的舵机角度,取值为正时，夹爪会收紧，取值范围是[-65,65]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的机械臂小臂的舵机",
            [
                Parameter('data', '机械狗的机械臂小臂的舵机角度,初始为70，此时大臂和小臂紧紧贴合，取值越小，大臂和小臂的角度越大，取值范围是[-85,50]', ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "机械狗的机械臂大臂的舵机",
            [
                Parameter('data', '机械狗的机械臂大臂的舵机角度,取值范围是[-75,90]，初始为-85，此时大臂和机身紧紧贴合，取值越大，大臂和机身的角度越大', ValueType.NUMBER, True)
            ],
    ...
    def _gait(self, gait_mode):
        ...
        self.dog.gait.type(self.gait_type)
